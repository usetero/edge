...
pub fn main() !void {
    ...
    var file_provider_interfaces: std.ArrayList(policy_provider.PolicyProvider) = .empty;
    defer file_provider_interfaces.deinit(allocator);

    var http_provider_interfaces: std.ArrayList(policy_provider.PolicyProvider) = .empty;
    ...
    for (config.policy_providers) |provider_config| {
        switch (provider_config.type) {
            .file => {
                ...
                try file_provider_interfaces.append(allocator, policy_provider.PolicyProvider.init(file_provider));
            ...
            .http => {
                ...
                // Register provider with registry for error/stats routing
                try http_provider_interfaces.append(allocator, policy_provider.PolicyProvider.init(http_provider));
